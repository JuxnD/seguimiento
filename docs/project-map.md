...
| Cambiar la llave de firma | Android no deja actualizar; hay que desinstalar y se pierden los datos | Llave única en secrets, documentada | ADR 0006 · `docs/actualizaciones.md` | **Abierto y activo**: no hay secrets; todas las releases van firmadas a mano con la llave debug del equipo de desarrollo. Ver "Estado real de la firma" |
