...
| Cambiar la llave de firma | Android no deja actualizar; hay que desinstalar y se pierden los datos | Una sola llave: la debug del equipo, subida como secret (24 sep 2026) | ADR 0006 · `docs/actualizaciones.md` ("La llave de las releases") | **Pendiente**: confirmar la huella en la primera release de CI y respaldar `debug.keystore` fuera del equipo |
